...
set identity_insert [dbo].[SensorStatus] on
INSERT INTO [dbo].[SensorStatus](
    [Id]
    ,[Type]
    ,[IsWorking]
    ,[GreenHouseId]
...
SELECT[Id]
        ...
        ,[IsWorking]
        ,[GreenHouseId]
FROM [GreenHouseDB].[dbo].[SensorStatus]
set identity_insert [dbo].[SensorStatus] off
